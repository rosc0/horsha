...
class Search extends PureComponent {
  constructor(props) {
    ...
    this.cancelButtonWidth = this.props.cancelButtonWidth || 60
    ...
    this.inputFocusWidthAnimated = new Animated.Value(width)
      ...
      >
        ...
        <TouchableWithoutFeedback onPress={this.onFocus}>
          {this.props.iconSearch ? (
            <Animated.View style={[styles.iconSearch, { left: 15 }]}>
              {this.props.iconSearch}
            </Animated.View>
          ) : (
            <Animated.Image
