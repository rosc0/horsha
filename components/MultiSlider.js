...
export default class MultiSlider extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      this.props.values[0] !== this.state.valueOne ||
      this.props.sliderLength !== prevProps.sliderLength ||
      this.props.values[1] !== this.state.valueTwo ||
      (this.props.sliderLength !== prevProps.sliderLength &&
        this.props.values[1])
    ) {
      this.optionsArray =
        prevProps.optionsArray ||
        createArray(this.props.min, this.props.max, this.props.step)

      this.stepLength = prevProps.sliderLength / this.optionsArray.length

      let positionOne = valueToPosition(
        this.props.values[0],
        this.optionsArray,
      ...
      let positionTwo = valueToPosition(
        this.props.values[1],
        this.optionsArray,
        this.props.sliderLength
      )
